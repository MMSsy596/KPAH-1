    ...
    private void showBuffCoinDialog(String playerName) {
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            switch (type) {
                ...
                case "Lượng":
                    if (op.equals("Cộng")) {
                        JOptionPane.showMessageDialog(null, "Luong chi duoc cong tu Bao may man. Admin chi co the tru khi can truy thu.");
                        return;
                    } else {
                ...
                case "Lượng Khóa":
                    if (op.equals("Cộng")) {
                        JOptionPane.showMessageDialog(null, "Luong khoa chi duoc cong tu Bao may man. Admin chi co the tru khi can truy thu.");
                        return;
                    } else {
