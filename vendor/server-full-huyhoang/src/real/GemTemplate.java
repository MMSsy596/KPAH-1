...
public class GemTemplate extends OtherItem
{
    ...
    public static short AN_HAC_THI;
    public static short MANH_CO_VAT;
    public static short RUONG_HANG_NONG;
    public static short BUA_GIU_SAO;
    public static short LENH_VAN_TIEU_CUC_HIEM;
    public static short DA_KHAM_10_SM;
    public static short DA_KHAM_10_NN;
    public static short DA_KHAM_10_TT;
    public static short DA_KHAM_10_SK;
    public static short DA_GAY_CHOANG_5;
    public static short DA_TANG_ROT_BAO_VAT_5;
    ...
    static {
        ...
        GemTemplate.AN_HAC_THI = 269;
        GemTemplate.MANH_CO_VAT = 270;
        GemTemplate.RUONG_HANG_NONG = 271;
        GemTemplate.BUA_GIU_SAO = 272;
        GemTemplate.LENH_VAN_TIEU_CUC_HIEM = 273;
        GemTemplate.DA_KHAM_10_SM = 274;
        GemTemplate.DA_KHAM_10_NN = 275;
        GemTemplate.DA_KHAM_10_TT = 276;
        GemTemplate.DA_KHAM_10_SK = 277;
        GemTemplate.DA_GAY_CHOANG_5 = 278;
        GemTemplate.DA_TANG_ROT_BAO_VAT_5 = 279;
    ...
    public static boolean isSocketDrill(final int id) {
        return id >= 60 && id <= 65;
    }

    public static boolean isSocketGem(final int id) {
        return (id >= 12 && id <= 59) || (id >= GemTemplate.DA_KHAM_10_SM && id <= GemTemplate.DA_TANG_ROT_BAO_VAT_5);
    }

    public static int getSocketAttributeIndex(final int id) {
        if (id >= 12 && id <= 59) {
            return 10 + GemTemplate.indexKham[id - 12];
        }
        switch (id) {
            case 274:
                return 10;
    ...
    public void khamItem(final Item item) {
        ...
        final int n = GemTemplate.getSocketAttributeIndex(this.id);
        if (n < 0) {
            return;
        }
        atb[n] += this.value;
