...
final class Function {
    private static Logger logger = Logger.getLogger(class$jxl$biff$formula$Function == null ? (class$jxl$biff$formula$Function = Function.class$("jxl.biff.formula.Function")) : class$jxl$biff$formula$Function);
    ...
    private Function(int v, String s, int a) {
        ...
        newarray[Function.functions.length] = this;
        functions = newarray;
    }
    ...
    public static Function getFunction(int v) {
        ...
        for (int i = 0; i < functions.length; ++i) {
            if (Function.functions[i].code != v) continue;
            f = functions[i];
            break;
        }
