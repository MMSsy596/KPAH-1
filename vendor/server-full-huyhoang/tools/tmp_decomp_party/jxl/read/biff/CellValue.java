...
CellFeaturesAccessor {
    private static Logger logger = Logger.getLogger(class$jxl$read$biff$CellValue == null ? (class$jxl$read$biff$CellValue = CellValue.class$("jxl.read.biff.CellValue")) : class$jxl$read$biff$CellValue);
    private int row;
    private int column;
    private int xfIndex;
