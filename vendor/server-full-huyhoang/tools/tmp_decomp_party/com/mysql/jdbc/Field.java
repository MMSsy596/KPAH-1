    ...
    public synchronized String getCollation() throws SQLException {
        block8: {
            block9: {
                ...
                block7: {
                    if (this.collationName != null || this.connection == null || !this.connection.versionMeetsMinimum(4, 1, 0)) break block8;
                    if (!this.connection.getUseDynamicCharsetInfo()) break block9;
                    ...
                    if (csCatalogName == null || csCatalogName.length() == 0 || csTableName == null || csTableName.length() == 0 || csColumnName == null || csColumnName.length() == 0) break block8;
                    ...
                    try {
                        ...
                        Object var10_9 = null;
                        if (collationRs == null) break block7;
                    }
