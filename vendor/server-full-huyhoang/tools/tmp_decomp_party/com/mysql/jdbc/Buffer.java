...
class Buffer {
    ...
    final String readString(String encoding) throws SQLException {
        ...
        try {
            String string = new String(this.byteBuffer, this.position, len, encoding);
            return string;
        }
    ...
    final void writeLenString(String s, String encoding, String serverEncoding, SingleByteCharsetConverter converter, boolean parserKnowsUnicode, Connection conn) throws UnsupportedEncodingException, SQLException {
        byte[] b = null;
        b = converter != null ? converter.toBytes(s) : StringUtils.getBytes(s, encoding, serverEncoding, parserKnowsUnicode, conn);
        int len = b.length;
        this.ensureCapacity(len + 9);
        this.writeFieldLength(len);
        System.arraycopy(b, 0, this.byteBuffer, this.position, len);
    ...
    final void writeStringNoNull(String s, String encoding, String serverEncoding, boolean parserKnowsUnicode, Connection conn) throws UnsupportedEncodingException, SQLException {
