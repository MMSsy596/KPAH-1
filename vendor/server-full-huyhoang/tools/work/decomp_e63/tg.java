...
implements gj {
    ...
    public final void a() {
        if (hw.aT[this.a.c] > 0) {
            acv.u.a = false;
            byte by2 = qz.c[acv.s.t.aP][this.a.c - 4];
            int n2 = qz.b(this.a.c, hw.aT[this.a.c - 4]);
            if (n2 > acv.s.t.bA) {
                if (!this.a.H) {
            ...
            if (acv.s.u != null && acv.s.u.cG == 0) {
                ...
                acv.s.t.bA -= n2;
                if (this.b && (acv.s.X == -1 || acv.s.X == this.a.c)) {
                    acv.s.X = this.a.c;
                }
                this.a.a(acv.s.t, acv.s.u, (int)by2, qz.d[acv.s.t.aP][this.a.c - 4] == 1);
                return;
            }
            if (this.a.c != 6) {
                acv.s.t.bA -= n2;
