...
extends aae {
    ...
    public final void f() {
        Object v3;
        acv.h();
        Object v1 = GameMidlet.a("http://163.61.183.129/NQSH2.txt");
        if (v1 == null) {
            acv.a("Kh\u00f4ng th\u1ec3 k\u1ebft n\u1ed1i, xin ki\u1ec3m tra l\u1ea1i GPRS/3G/Wifi.");
            return;
        }
        v1 = d.a((String)v1, ",");
        b = new String[((String[])v1).length];
        c = new String[((String[])v1).length];
        d = new short[((String[])v1).length];
        e = new byte[((String[])v1).length];
        int i2 = 0;
        while (i2 < ((String[])v1).length) {
            v3 = d.a(v1[i2], ":");
            yv.b[i2] = v3[0];
            yv.c[i2] = v3[1];
            yv.d[i2] = Short.parseShort(v3[2].trim());
            yv.e[i2] = Byte.parseByte(v3[3].trim());
            ++i2;
        }
        v1 = new ByteArrayOutputStream();
        DataOutputStream v2 = new DataOutputStream((OutputStream)v1);
        try {
            v2.writeByte(b.length);
            int i3 = 0;
            while (i3 < b.length) {
                v2.writeUTF(b[i3]);
                v2.writeUTF(c[i3]);
            ...
            aai.a("ipnqsh", ((ByteArrayOutputStream)v1).toByteArray());
            v2.close();
        }
