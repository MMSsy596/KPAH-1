...
public class BossSkelonton extends Boss {
    ...
    public BossSkelonton(Map mapLiveIn, MonsterTemplate template, int x, int y, int country) {
    ...
    public Vector<GemItem> dropListGemItem() {
        ...
        if (this.idTemplate != 113 && this.idTemplate != 115) {
            ...
            // Thêm item 268 cho boss 94
            if (this.idTemplate == 94) {
            ...
            if (this.idTemplate == 113) {
                ...
                gem.add(new GemItem(268)); // Thêm item 268 cho boss 113
            } else {
                GemItem gg = new GemItem(GemTemplate.LKD_40);
                gg.islock = true;
                gem.add(gg);
                gem.add(new GemItem(268)); // Thêm item 268 cho boss 115
            }
