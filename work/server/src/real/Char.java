...
public class Char extends LiveActor {
    ...
    public int[] tPotions;
    public int[] rPotions;
    public Vector<Long> gioToPhoenixLuaEggExpires;
    public Vector<Long> gioToPhoenixBangEggExpires;
    public Vector<Integer> hideExpireAnimalDbIds;
    public boolean hideExpireAnimalDbIdsSynced;
    ...
    public static final int TRADE_TAX_PERCENT = 10;
    public static final byte TRADE_MONEY_XU = 0;
    public static final byte TRADE_MONEY_LUONG = 1;
    public static final byte TRADE_MONEY_LUONG_KHOA = 2;
    public long tXuTrade;
    public int tLuongTrade;
    public int tLuongKhoaTrade;
    ...
    public long timeReduceDurability;
    public int loginCompensationVersion;
    public long timeExpLock;
    private byte durabilityBlessWeaponTick;
    private byte durabilityBlessArmorTick;
    ...
    public static final int LOGIN_COMPENSATION_VERSION = 1;
    public static final int LOGIN_COMPENSATION_LUONG = 100;
    public static final long DAILY_RESET_OFFSET = -18000000L;
    private static final int LUCKY_BAG_HP_POTION_ID = 94;
    private static final int LUCKY_BAG_MP_POTION_ID = 96;
    private static final int DEFAULT_LUCKY_BAG_RESET_HOUR = 5;
    private static final int DEFAULT_LUCKY_BAG_RESET_MINUTE = 30;
    private static volatile int luckyBagResetHour = DEFAULT_LUCKY_BAG_RESET_HOUR;
    private static volatile int luckyBagResetMinute = DEFAULT_LUCKY_BAG_RESET_MINUTE;
    public static final int[] DURABILITY_BLESSING_MINUTES = new int[]{480};
    public static final int[] DURABILITY_BLESSING_PRICES = new int[]{10000};
    public static final int EXP_LOCK_HOURS = 12;
    public static final int EXP_LOCK_MINUTES = EXP_LOCK_HOURS * 60;
    public static final int EXP_LOCK_PRICE = 100;
    ...
    public static byte ID_TIME_DURABILITY_BLESSING;
    public static byte ID_TIME_EXP_LOCK;
    ...
    public static final int MAX_HOP_QUA_NONG_DAN_NGAY = 50;
    public static final int DEFAULT_LUCKY_BAG_OPEN_LIMIT_PER_DAY = 50;
    public static final long THOI_GIAN_DIEM_NONG_DAN_GIAI_DOAN_DAU = 10800000L;
    ...
    private static final String HOANG_CT_LEADER_ACCOUNT = "hoangct1";
    private static final String[] HOANG_CT_FOLLOWER_ACCOUNTS = new String[]{"hoangct2", "hoangct3", "hoangct4", "hoangct5"};
    private static final int[][] HOANG_CT_FOLLOW_OFFSETS = new int[][]{{-24, 24}, {24, 24}, {-24, -24}, {24, -24}};
    private static final int HOANG_CT_FOLLOW_STEP = 48;
    private static final int HOANG_CT_FOLLOW_NEAR = 20;
    private static final long HOANG_CT_FOLLOW_INTERVAL = 250L;
    long timeMove;
    private long timeHoangCtFollow;
    int lastMovex;
    int lastMovey;
    ...
    public byte gif35;
    public byte nHopMut;
    public int countBaoMayManOpen;
    public int luongBaoMayManDay;
    public int luongKhoaBaoMayManDay;
    public String dayLuckyBagReset;
    public int pArena;
    public int diemNongDan;
    public long lastTimeNhanAnHacThi;
    public int soHopQuaNongDanNgay;
    public long timeDat50HopQuaNongDan;
    public long timeOnlineNongDanNgay;
    public byte choDenSoLanTieuTimConLai;
    public int choDenKyDaMuaManh;
    public byte choDenSoManhDaMua;
    private transient long lastTimeOnlineNongDanTick;
    ...
    public byte tempWeddingType;
    public byte tempWeddingTime;
    public int idArena;
    public byte idFlag;
    ...
    public byte bankTransferType;
    public String bankTransferTargetName;
    public String bankPendingTransferSender;
    public byte bankPendingTransferType;
    public long bankPendingTransferAmount;
    public long bankPendingTransferTime;
    ...
    static {
        ...
        Char.ID_TIME_DURABILITY_BLESSING = 19;
        Char.ID_TIME_EXP_LOCK = 20;
...
//        } 
    ...
    public boolean hadGemItem(final int id) {
        return this.listGemitem[id] > 0 || this.listGemitemLock[id] > 0;
    }
    ...
    public void resetTradeData() {
        ...
        this.tPotions = new int[162];
        this.rPotions = new int[162];
        this.resetTradeMoney();
    }

    public static long getTradeMoneyReceive(final long amount) {
        return amount * (100 - TRADE_TAX_PERCENT) / 100L;
    }

    public static String getTradeMoneyName(final byte type) {
        switch (type) {
            case TRADE_MONEY_XU:
                return "Xu";
            case TRADE_MONEY_LUONG:
                return "Luong";
            case TRADE_MONEY_LUONG_KHOA:
                return "Luong khoa";
            default:
                return "";
        }
    ...
    public boolean setTradeMoney(final byte type, final long amount) {
        if (amount < 0L) {
            return false;
        }
        switch (type) {
            case TRADE_MONEY_XU:
                this.tXuTrade = amount;
                return true;
            case TRADE_MONEY_LUONG:
                if (amount > Integer.MAX_VALUE) {
                    return false;
                }
                this.tLuongTrade = (int) amount;
                return true;
            case TRADE_MONEY_LUONG_KHOA:
                if (amount > Integer.MAX_VALUE) {
                    return false;
                }
                this.tLuongKhoaTrade = (int) amount;
                return true;
            default:
                return false;
        }
    ...
    public long getTradeMoney(final byte type) {
        switch (type) {
            case TRADE_MONEY_XU:
                return this.tXuTrade;
            case TRADE_MONEY_LUONG:
                return this.tLuongTrade;
            case TRADE_MONEY_LUONG_KHOA:
                return this.tLuongKhoaTrade;
            default:
                return 0L;
        }
    }

    public boolean hasEnoughTradeMoney() {
        return this.getxu() >= this.tXuTrade && this.getLuong() >= this.tLuongTrade && this.getLuongLock() >= this.tLuongKhoaTrade;
    }

    public void subLuongTrade(final int luongTrade) {
        this.luong -= luongTrade;
        if (this.luong < 0) {
            this.luong = 0;
        }
    }

    public void doAddMoneyTrade() {
        if (this.userTrade.size() == 0) {
            return;
        }
        final Char tradePartner = this.userTrade.get(0);
        if (this.tLuongTrade > 0 || tradePartner.tLuongTrade > 0 || this.tLuongKhoaTrade > 0 || tradePartner.tLuongKhoaTrade > 0) {
            this.tLuongTrade = 0;
            tradePartner.tLuongTrade = 0;
            this.tLuongKhoaTrade = 0;
            tradePartner.tLuongKhoaTrade = 0;
            this.sendMessage(MessageCreator.createServerAlertMessage("Luong va luong khoa chi nhan tu Bao may man, da bo qua phan tien nay trong giao dich.", ""));
            tradePartner.sendMessage(MessageCreator.createServerAlertMessage("Luong va luong khoa chi nhan tu Bao may man, da bo qua phan tien nay trong giao dich.", ""));
        }
        final long receiveXu = getTradeMoneyReceive(this.tXuTrade);
        final int receiveLuong = (int) getTradeMoneyReceive(this.tLuongTrade);
        final int receiveLuongKhoa = (int) getTradeMoneyReceive(this.tLuongKhoaTrade);
        final long partnerReceiveXu = getTradeMoneyReceive(tradePartner.tXuTrade);
        final int partnerReceiveLuong = (int) getTradeMoneyReceive(tradePartner.tLuongTrade);
        final int partnerReceiveLuongKhoa = (int) getTradeMoneyReceive(tradePartner.tLuongKhoaTrade);
        if (this.tXuTrade > 0L) {
            this.subXu(this.tXuTrade, false, "trade_money");
        }
        if (tradePartner.tXuTrade > 0L) {
            tradePartner.subXu(tradePartner.tXuTrade, false, "trade_money");
        }
        if (partnerReceiveXu > 0L) {
            this.addXu(partnerReceiveXu, "trade_money_receive");
        }
        if (receiveXu > 0L) {
            tradePartner.addXu(receiveXu, "trade_money_receive");
        }
        if (this.tLuongTrade > 0) {
            this.subLuongTrade(this.tLuongTrade);
        }
        if (tradePartner.tLuongTrade > 0) {
            tradePartner.subLuongTrade(tradePartner.tLuongTrade);
        }
        if (partnerReceiveLuong > 0) {
            this.addLuong(partnerReceiveLuong);
        }
        if (receiveLuong > 0) {
            tradePartner.addLuong(receiveLuong);
        }
        if (this.tLuongKhoaTrade > 0) {
            this.subLuongLock(this.tLuongKhoaTrade);
        }
        if (tradePartner.tLuongKhoaTrade > 0) {
            tradePartner.subLuongLock(tradePartner.tLuongKhoaTrade);
        }
        if (partnerReceiveLuongKhoa > 0) {
            this.addLuongLock(partnerReceiveLuongKhoa);
        }
        if (receiveLuongKhoa > 0) {
            tradePartner.addLuongLock(receiveLuongKhoa);
        }
        final String info = this.charname
                + " gui_Xu_" + this.tXuTrade
                + "_Luong_" + this.tLuongTrade
                + "_LuongKhoa_" + this.tLuongKhoaTrade
                + " >> " + tradePartner.charname
                + " gui_Xu_" + tradePartner.tXuTrade
                + "_Luong_" + tradePartner.tLuongTrade
                + "_LuongKhoa_" + tradePartner.tLuongKhoaTrade
                + " ||| NhanSauThue_" + this.charname
                + "_Xu_" + partnerReceiveXu
                + "_Luong_" + partnerReceiveLuong
                + "_LuongKhoa_" + partnerReceiveLuongKhoa
                + " >> " + tradePartner.charname
                + "_Xu_" + receiveXu
                + "_Luong_" + receiveLuong
                + "_LuongKhoa_" + receiveLuongKhoa;
        try {
            Database.instance.saveLogTradeItem(this.charname, tradePartner.charname, info);
        } catch (final Exception e) {
            e.printStackTrace();
        }
        this.resetTradeMoney();
        tradePartner.resetTradeMoney();
    }
    ...
    private void calculateCritical() {
        ...
        int crit2 = 0;
        if (this.charClass == 4) {
            crit1 = (this.getLuckyValue() + getEffSkillClan(3)) / 5;
        }
    ...
    private void calculateMaxHPMP() {
        ...
        this.maxhp = this.applyDanChoiThuThietBonus(this.maxhp);
        this.maxmp = this.applyDanChoiThuThietBonus(this.maxmp);
        if (this.hp > this.maxhp) {
            this.hp = this.maxhp;
        }
        if (this.mp > this.maxmp) {
    ...
    private void calculateDefend() {
        ...
        if (this.hasHoangCtAbsoluteDefenseBuff()) {
            this.defend_magic = 100000;
            this.defend_physic = 100000;
            this.defendMaPlayer = 100000;
            this.defendVatPlayer = 100000;
    ...
    public void buffAttackSkill(final Monster mt, final int d) {
        ...
        try {
            ...
            if (damPhan > 0) {
                if ((mt instanceof KhaBanhBoss && !((KhaBanhBoss) mt).canBeDamagedBy(this))
                        || (mt instanceof KhaBanhMinion && !((KhaBanhMinion) mt).canBeDamagedBy(this))) {
                    return;
                }
    ...
    public int checkHapthuSatThuong(final int dam, final LiveActor actor) {
        if (actor.isBossSonTinhThuyTinh()) {
            return this.clampIncomingDamageForHoangCt(dam);
        }
        int finalDam = dam;
        ...
        return this.clampIncomingDamageForHoangCt(finalDam);
    }
    ...
    public int getDamtThanThu(final LiveActor ac) {
        if (this.charthanthu != null) {
            int damage = this.charthanthu.attackDam(ac);
            if (ac instanceof Char) {
                damage = ((Char) ac).clampIncomingDamageForHoangCt(damage);
            }
            return damage;
        }
        return 0;
    ...
    public int getDamtThanThuAuto(final LiveActor ac) {
        if (this.charthanthu != null) {
            int damage = this.charthanthu.attackDamAuto(ac);
            if (ac instanceof Char) {
                damage = ((Char) ac).clampIncomingDamageForHoangCt(damage);
            }
            return damage;
    ...
    public void charHireAttackDam(final LiveActor actor, final int type, final int level, final int bubbAttack) {
        try {
            if (this.charHire != null && this.charHire.hp > 0) {
                if (actor.isRuongMaquai() || actor.isNgocRong()) {
                    return;
                }
    ...
    private boolean hasActiveDanhHieu(int id) {
        for (int i = 0; i < this.allDanhHieu.size(); i++) {
            DanhHieu danhHieu = this.allDanhHieu.get(i);
            if (danhHieu.ideff == id && !danhHieu.isExpire()) {
                return true;
            }
        }
        return false;
    ...
    private int applyDanChoiThuThietBonus(int value) {
        if (value <= 0 || !this.hasActiveDanhHieu(DanhHieu.DAN_CHOI_THU_THIET)) {
            return value;
        }
    ...
    public int getLuckyValue() {
        return this.applyDanChoiThuThietBonus(this.luck);
    }

    @Override
    public int getAttack() {
        int attackValue = super.getAttack() + this.getValueLua(2) * this.attack / 100;
        return this.applyDanChoiThuThietBonus(attackValue);
    }

    @Override
    public int getDefendPhysic() {
        int defend = super.getDefendPhysic();
        return this.applyDanChoiThuThietBonus(defend);
    }

    @Override
    public int getDefendMagic() {
        int defend = super.getDefendMagic();
        return this.applyDanChoiThuThietBonus(defend);
    }
    ...
    public int attackDam(final LiveActor actor, final int idSkill, final int level, final int bubbAttack) {
        ...
        if (actor instanceof KhaBanhBoss && !((KhaBanhBoss) actor).canBeDamagedBy(this)) {
            return 0;
        }
        if (actor instanceof KhaBanhMinion && !((KhaBanhMinion) actor).canBeDamagedBy(this)) {
            return 0;
        }
        Pet petUsing = this.petUsing;
        Animal animalRide = this.animalRide;
        ...
        try {
            ...
            if (actor.isNgocRong()) {
                ...
                if (!actor.isRuongMaquai()) {
                    ...
                    finalDame = this.applyKhaBanhTestDamage(actor, finalDame);
                    return finalDame;
                }
    ...
    public void checkExpireAnimal() {
        try {
            final Vector<Animal> animalExpire = new Vector<Animal>();
            for (int i = 0; i < this.animal.size(); ++i) {
                final Animal animal = this.animal.get(i);
                if (animal != null && animal.timeExpire()) {
                    animalExpire.add(animal);
                }
            }
            if (animalExpire.isEmpty()) {
                return;
            }

            boolean rideExpired = false;
            boolean hideExpireChanged = false;
            String expiredRideName = "";
            for (int i = 0; i < animalExpire.size(); ++i) {
                final Animal animal = animalExpire.get(i);
                if (animal == this.animalRide || (this.animalRide != null && this.animalRide.id == animal.id)) {
                    rideExpired = true;
                    expiredRideName = animal.getName();
                }
                this.animal.remove(animal);
                if (this.removeHideAnimalExpireClient(animal)) {
                    hideExpireChanged = true;
                }
                if (animal.dbid > 0) {
                    Database.instance.delAnimal(animal.dbid);
                }
                Database.instance.saveOrtherLog("tob_log_other_animal", this.charname, animal.getName() + "|" + animal.getAttribute(), "timeout");
            }
            ...
            if (rideExpired) {
                ...
                this.sendToNearPlayer(MessageCreator.createCharInfo(this));
                this.sendMessage(MessageCreator.createCharWearingMessage(this, this));
                this.sendMessage(MessageCreator.createAnimalWearingMessage(this, this));
                MessageCreator.createMsgCharMonster(this, this);
                this.sendMessage(MessageCreator.createServerAlertAutoOffMessage("Linh thu " + expiredRideName + " da het thoi gian su dung"));
                Database.instance.saveChar(this, false);
            } else if (hideExpireChanged) {
                Database.instance.saveChar(this, false);
            }
        } catch (final Exception e) {
            e.printStackTrace();
    ...
    public void checkExpireGioToPhoenixEggs() {
        try {
            final int removed = this.cleanupGioToPhoenixEggs();
            if (removed > 0) {
    ...
    public boolean hasDurabilityBlessing() {
        return this.timeReduceDurability > System.currentTimeMillis();
    }

    public int getRemainDurabilityBlessingMinute() {
        if (!this.hasDurabilityBlessing()) {
            return 0;
        }
        return (int) Math.ceil((this.timeReduceDurability - System.currentTimeMillis()) / 60000.0);
    }

    public boolean isExpLocked() {
        return this.timeExpLock > System.currentTimeMillis();
    }

    public int getRemainExpLockMinute() {
        if (!this.isExpLocked()) {
            return 0;
        }
        return (int) Math.ceil((this.timeExpLock - System.currentTimeMillis()) / 60000.0);
    }

    private int getRemainBuffSecond(final long expireAt) {
        if (expireAt <= System.currentTimeMillis()) {
            return 0;
        }
        return (int) Math.ceil((expireAt - System.currentTimeMillis()) / 1000.0);
    }

    public int getRemainDurabilityBlessingSecond() {
        return this.getRemainBuffSecond(this.timeReduceDurability);
    }

    public int getRemainExpLockSecond() {
        return this.getRemainBuffSecond(this.timeExpLock);
    }

    private void sendTimedBuffCountdown(final byte id, final String title, final int remainSeconds) {
        if (remainSeconds <= 0) {
            return;
        }
        this.sendMessage(MessageCreator.createMsgTimeCountdown(title, remainSeconds, -1, id, Map.COUNT_DOWN, -1));
    }

    public void syncTimedBuffCountdowns() {
        if (this.hasDurabilityBlessing()) {
            this.sendTimedBuffCountdown(Char.ID_TIME_DURABILITY_BLESSING, "Bùa chống hao mòn", this.getRemainDurabilityBlessingSecond());
        }
        if (this.isExpLocked()) {
            this.sendTimedBuffCountdown(Char.ID_TIME_EXP_LOCK, "Thẻ khóa EXP", this.getRemainExpLockSecond());
        }
    }

    public void activateExpLock() {
        final boolean wasActive = this.isExpLocked();
        this.timeExpLock = System.currentTimeMillis() + EXP_LOCK_MINUTES * 60000L;
        final String message = wasActive
                ? "Đã reset thời gian Thẻ khóa EXP về " + EXP_LOCK_HOURS + " giờ. Còn lại " + this.getRemainExpLockMinute() + " phút."
                : "Đã kích hoạt Thẻ khóa EXP trong " + EXP_LOCK_HOURS + " giờ. Còn lại " + this.getRemainExpLockMinute() + " phút.";
        try {
            this.sendMessage(MessageCreator.createServerAlertAutoOffMessage(message));
        } catch (final IOException ex) {
            ex.printStackTrace();
        }
        this.syncTimedBuffCountdowns();
        Database.instance.saveChar(this, false);
    }

    public boolean applyLoginCompensationIfNeeded() {
        if (this.loginCompensationVersion < LOGIN_COMPENSATION_VERSION) {
            this.loginCompensationVersion = LOGIN_COMPENSATION_VERSION;
            Database.instance.saveOrtherLog(
                "",
                this.charname,
                "bo qua " + LOGIN_COMPENSATION_LUONG + " luong den bu dang nhap v" + LOGIN_COMPENSATION_VERSION
                        + " vi server chi cho phep nhan luong va luong khoa tu Bao may man",
                "login_compensation_suppressed"
            );
            Database.instance.saveChar(this, false);
        }
        return false;
    ...
    public void activateDurabilityBlessing(final int option) {
        if (option < 0 || option >= DURABILITY_BLESSING_MINUTES.length) {
            return;
        }
        final long baseTime = Math.max(System.currentTimeMillis(), this.timeReduceDurability);
        this.timeReduceDurability = baseTime + DURABILITY_BLESSING_MINUTES[option] * 60000L;
        this.durabilityBlessWeaponTick = 0;
        this.durabilityBlessArmorTick = 0;
        try {
            this.sendMessage(
                MessageCreator.createServerAlertAutoOffMessage(
                    "Kích hoạt Bùa chống hao mòn trong " + DURABILITY_BLESSING_MINUTES[option] + " phút. Còn lại " + this.getRemainDurabilityBlessingMinute() + " phút."
                )
            );
        } catch (final IOException ex) {
            ex.printStackTrace();
    ...
    public void buyDurabilityBlessing(final int option) {
        if (option < 0 || option >= DURABILITY_BLESSING_MINUTES.length) {
            return;
        }
        final int price = DURABILITY_BLESSING_PRICES[option];
        if (this.xu < price) {
        ...
        this.activateDurabilityBlessing(option);
        Database.instance.saveOrtherLog(
            "tob_log_other_item",
            this.charname,
            String.valueOf(price) + " xu mua bùa chống hao mòn " + DURABILITY_BLESSING_MINUTES[option] + " phút",
            "durability_bless"
        );
    }

    private boolean shouldDownDurability(final boolean isWeapon) {
        if (!this.hasDurabilityBlessing()) {
            if (isWeapon) {
                this.durabilityBlessWeaponTick = 0;
            } else {
        ...
        if (isWeapon) {
            ++this.durabilityBlessWeaponTick;
            if (this.durabilityBlessWeaponTick < 2) {
                return false;
            }
            this.durabilityBlessWeaponTick = 0;
            return true;
        }
        ++this.durabilityBlessArmorTick;
        if (this.durabilityBlessArmorTick < 2) {
            return false;
        }
        this.durabilityBlessArmorTick = 0;
        return true;
    ...
    public void downDurableWeapone() {
        if (!this.shouldDownDurability(true)) {
            return;
        }
        final Vector<Item> wItems = this.getCharWearing();
        for (final Item item : wItems) {
    ...
    public void downDuarable() {
        if (!this.shouldDownDurability(false)) {
            return;
        }
        final Vector<Item> wItems = this.getCharWearing();
        for (final Item item : wItems) {
    ...
    public Char(final Session conn) {
        ...
        this.tPotions = new int[162];
        this.rPotions = new int[162];
        this.gioToPhoenixLuaEggExpires = new Vector<Long>();
        this.gioToPhoenixBangEggExpires = new Vector<Long>();
        this.hideExpireAnimalDbIds = new Vector<Integer>();
        this.hideExpireAnimalDbIdsSynced = false;
        ...
        this.gif35 = 0;
        this.nHopMut = -1;
        this.countBaoMayManOpen = 0;
        this.luongBaoMayManDay = 0;
        this.luongKhoaBaoMayManDay = 0;
        this.dayLuckyBagReset = "";
        this.timeExpLock = 0L;
        this.pArena = 1;
        this.diemNongDan = 0;
        this.soHopQuaNongDanNgay = 0;
        this.timeDat50HopQuaNongDan = 0L;
        this.timeOnlineNongDanNgay = 0L;
        this.choDenSoLanTieuTimConLai = 0;
        this.choDenKyDaMuaManh = -1;
        this.choDenSoManhDaMua = 0;
        this.lastTimeOnlineNongDanTick = 0L;
        ...
        this.honor = 0;
        this.idWedding = -1;
        this.tempWeddingType = -1;
        this.tempWeddingTime = -1;
        this.idArena = -1;
        this.idFlag = -1;
        this.maxKill = 0;
        this.idGropRace = -1;
        ...
        this.moneyTrade = 0;
        this.bankTransferType = -1;
        this.bankTransferTargetName = null;
        this.bankPendingTransferSender = null;
        this.bankPendingTransferType = -1;
        this.bankPendingTransferAmount = 0L;
        this.bankPendingTransferTime = 0L;
...
//    }
    ...
    // Rare colors were increased by +5 percentage points each, so common colors
    // are reduced proportionally to keep the total chance at 100%.
    private static final int[] VAN_TIEU_RECEIVE_COLOR_WEIGHTS = {510, 248, 87, 53, 51, 51};
    private static final int[] VAN_TIEU_CHANGE_NORMAL_COLOR_WEIGHTS = {424, 297, 113, 60, 54, 52};
    private static final int[] VAN_TIEU_CHANGE_PREMIUM_COLOR_WEIGHTS = {168, 252, 370, 80, 70, 60};
    private static final String ESCORT_TEST_ACCOUNT = "s2apolo2s";

    private static int getVanTieuColorIndex(final int[] weights) {
        final int roll = Map.r.nextInt(1000);
        int total = 0;
    ...
    public static synchronized void doInitMonter(final Char p, final int typetieu) {
        try {
            final boolean escortTestBypass = p != null && p.hasEscortTestAccess();
            if (p.monster != null) {
            ...
            if (!escortTestBypass && p.luot_van_tieu < 1) {
            ...
            final boolean forcePurpleTieu = p.choDenSoLanTieuTimConLai > 0;
            final int indexMons = forcePurpleTieu ? 5 : getVanTieuColorIndex(VAN_TIEU_RECEIVE_COLOR_WEIGHTS);
            ...
            if (forcePurpleTieu) {
                --p.choDenSoLanTieuTimConLai;
                if (p.choDenSoLanTieuTimConLai < 0) {
                    p.choDenSoLanTieuTimConLai = 0;
                }
                p.sendMessage(MessageCreator.createServerAlertMessage("Lenh van tieu cuc hiem da kich hoat: con " + p.choDenSoLanTieuTimConLai + " luot tieu tim.", ""));
                Database.instance.saveCharAuto(p);
            }
            if (!escortTestBypass && !p.isAdmin && TeamServer.server != 100) {
                --p.luot_van_tieu;
            }
    ...
    public void doChangeTieu(final int xu_luong) {
        synchronized (Map.CHANGE_TIEU) {
            ...
            final int[][] idMonster = {{95, 96, 97, 98, 99, 100}, {101, 102, 103, 104, 105, 106}, {107, 108, 109, 110, 111, 112}};
            final int index = getVanTieuColorIndex(xu_luong == 0 ? VAN_TIEU_CHANGE_NORMAL_COLOR_WEIGHTS : VAN_TIEU_CHANGE_PREMIUM_COLOR_WEIGHTS);
            try {
                final Message m = new Message(90);
    ...
    public void doResponseTieu(final Char pReceive, final boolean isThief, final int type, int lvOpen) {
        try {
            synchronized (Map.FINISH_TIEU) {
                ...
                final int[] luongadd = {0, 0, 0, 70, 100 + Map.r.nextInt(11), 100 + Map.r.nextInt(11), 0};
                final int[] luongLockAdd = {0, 0, 0, 90, luongadd[4], luongadd[5], 0};
                final int[] luongNormalLowColor = {10, 20, 35};
                ...
                if (random >= 80) {
                    ...
                    luongLockAdd[4] = luongadd[4];
                    luongLockAdd[5] = luongadd[5];
                }
                ...
                if (typeTieu == Char.INDIVITUAL) {
                    long exp = 0L;
                    if (TeamServer.ExpVantieu && (!TeamServer.isServerHoaLu() || !isSuKienDuaTopHoaLu())) {
                        exp = this.getVanTieuExpReward(pReceive, colortieu, isThief);
                    ...
                    if (!isThief && colortieu < luongNormalLowColor.length) {
                        final int luongReward = luongNormalLowColor[colortieu];
                        this.addLuongFromVanTieu(luongReward);
                        info = String.valueOf(info) + " va " + luongReward + " luong";
                        this.sendMessage(MessageCreator.createCharInventoryMessage(pReceive, 0));
                    } else if (!isThief && colortieu >= 3) {
                        final int luongReward = luongadd[colortieu];
                        final int luongLockReward = luongLockAdd[colortieu];
                        this.addLuongFromVanTieu(luongReward);
                        this.addLuongLockFromVanTieu(luongLockReward);
                        info = String.valueOf(info) + " và " + luongReward + " lượng và " + luongLockReward + " lượng khóa";
                        this.sendMessage(MessageCreator.createCharInventoryMessage(pReceive, 0));
                    } else if (colortieu >= 4 && luongadd[colortieu] > 0) {
                        final boolean notlock = Map.r.nextInt(1000) < 5;
                        if (!notlock) {
                            this.addLuongLockFromVanTieu(luongadd[colortieu] / div);
                        } else {
                            this.addLuongFromVanTieu(luongadd[colortieu] / div);
                        }
    ...
    private long getVanTieuExpReward(final Char pReceive, final int colorTieu, final boolean isThief) {
        final int basePercent = this.getVanTieuBaseExpPercent(colorTieu);
        final int rewardLevel = this.getVanTieuExpRewardLevel(pReceive.lvDetail.lv);
        if (basePercent <= 0 || rewardLevel <= 0 || rewardLevel >= LevelDetail.expRequire.length) {
            return 0L;
        }
        // Van tieu uses a fixed EXP table and should not be amplified by x2/x2.5,
        // gio vang, country EXP events, or firework EXP buffs.
        long scaledPercent = basePercent * 100L;
        if (isThief) {
            scaledPercent /= 2L;
        }
        long exp = LevelDetail.expRequire[rewardLevel] * scaledPercent / 10000L;
        if (exp <= 0L && scaledPercent > 0L) {
            exp = 1L;
        }
        return exp;
    }

    private int getVanTieuExpRewardLevel(final int currentLevel) {
        if (currentLevel <= 0) {
            return 0;
        }
        if (currentLevel < 40) {
        ...
        return 40 + (currentLevel - 40) / 5 * 5;
    }

    private int getVanTieuBaseExpPercent(final int colorTieu) {
        final int[] basePercent = {1, 2, 3, 4, 5, 6};
        if (colorTieu < 0 || colorTieu >= basePercent.length) {
            return 0;
        }
        return basePercent[colorTieu];
    }

    private int getVanTieuExpCapPercent(final int personalMultiplier, final int serverMultiplier, final boolean hasPhaoHoaBuff, final boolean hasPhaoServerBuff) {
        int boostCount = 0;
        if (personalMultiplier > 100) {
            ++boostCount;
        }
        if (serverMultiplier > 100) {
            ++boostCount;
        }
        if (hasPhaoHoaBuff) {
            ++boostCount;
        }
        if (hasPhaoServerBuff) {
            ++boostCount;
        }
        if (boostCount <= 0) {
            return 30;
    ...
    private int getVanTieuPersonalExpMultiplier() {
        if (this.x25Exp > 0) {
            return 250;
        }
        if (this.x2 == 1) {
        ...
        if (this.x2 == 2 || this.x2 == 4 || this.x2 == 5) {
            return 200;
        }
        return 100;
    }

    private int getVanTieuServerExpMultiplier() {
        if (this.myCountry >= 0 && this.myCountry < Map.minuteX2Country.length && Map.minuteX2Country[this.myCountry] > 0L) {
            if (Map.x2Country[this.myCountry] == 1) {
                return 150;
            }
            if (Map.x2Country[this.myCountry] == 2) {
        ...
        int multiplier = 100;
        if (this.isVanTieuExpScheduleActive(Char.timex50)) {
            multiplier = 150;
        }
        if (this.isVanTieuExpScheduleActive(Char.timex2)) {
            multiplier = 200;
        }
        if (this.lvDetail.lv < Char.Lvx3Exp && this.isVanTieuExpScheduleActive(Char.timex3)) {
            multiplier = 300;
        }
        return multiplier;
    }

    private boolean isVanTieuExpScheduleActive(final Vector<String> schedules) {
        final String dayOpen = getDayOpen(0L);
        final String now = getDayTime(0L);
        for (int i = 0; i < schedules.size(); ++i) {
            final String schedule = schedules.get(i);
            if (dayOpen.equals(schedule) || now.compareTo(schedule) < 0) {
                return true;
            }
        }
        return false;
    ...
    public int getBackDam(final int dam) {
        if (this.hasHoangCtAbsoluteDefenseBuff()) {
            return this.getHoangCtReflectDamage(dam);
        }
        int backDam = dam;
    ...
    public boolean haveBackDam() {
        return this.hasHoangCtAbsoluteDefenseBuff()
                || this.hashEffBuff.get(EffectBuff.EFF_SHIELD_1) != null
                || this.hashEffBuff.get(EffectBuff.EFF_SHIELD_2) != null;
    }
        ...
        try {
            for (int i = 0; i < this.AllEffBuff.size(); ++i) {
                ...
                if (ef.idEff == EffectBuff.UONG_RUOU && System.currentTimeMillis() - this.timeRegentHpMp >= 5000L) {
                    ...
                    final int bleedDamage = this.clampIncomingDamageForHoangCt(2000);
                    this.hp -= bleedDamage;
                    if (this.hp <= 0) {
                        this.hp = 0;
                        this.actorDie();
                        ...
                        try {
                            MessageCreator.createMsgUseHpMP(this, -bleedDamage, 1);
                        } catch (final Exception ex2) {
                        }
                    }
                } else if (ef.idEff == EffectBuff.TRUNG_DOC && System.currentTimeMillis() - ef.timeCount >= 1000L) {
                    ef.timeCount = System.currentTimeMillis();
                    final int poisonDamage = this.clampIncomingDamageForHoangCt(ef.dam);
    ...
    public void update() {
        if (this.isBot != -1) {
            if (!AmbientBotManager.isAmbientBot(this) && !LuongSon108Manager.isGuardBot(this)) {
                this.hp = 1;
            }
            return;
        }
        ...
        if (this.countSecond % 60 == 0) {
            try {
                this.ensureHideExpireAnimalDbIdsSynced();
                this.checkExpireAnimal();
                this.checkExpireGioToPhoenixEggs();
            } catch (final Exception ex2) {
            }
        }
        if (this.countSecond >= 300) {
            ...
            if (this.updateOnlineNongDanTime() > 0L) {
                Database.instance.saveCharAuto(this);
            }
            this.countSecond = 0;
        }
...
//        }
        ...
        this.updateHoangCtSameMapFollow();
        ...
        if (this.isThodia && this.timeWaitComeHome > 0L && System.currentTimeMillis() - this.timeWaitComeHome >= 2000L) {
            try {
                if (this.map != null) {
                    this.map.doComeHomeWhenDie(this);
                }
        ...
        try {
            ...
            if (this.tDelay > 0 && System.currentTimeMillis() - this.timeOutPoinson >= this.tDelay * 1000) 
            {
                ...
                this.hp -= this.clampIncomingDamageForHoangCt(this.poinson);
...
// ... existing code ...    
    ...
    private void updateNearChar() {
        ...
        final int actorDisplayRange = Math.max(120, this.rangeAddMonster[0]);
        final Vector<Char> snapshotBots = new Vector<Char>();
        for (int j = this.nearChars.size() - 1; j >= 0; --j) {
            try {
                ...
                if (c != null) {
                    ...
                    final boolean snapshotBotNear = AmbientBotManager.isAmbientBot(c) || LuongSon108Manager.isGuardBot(c);
                    if (c.exit) {
                        this.nearChars.remove(j);
                        this.charOutRange(c);
                    } else if ((c.inCountry != this.inCountry && (c.isBot == -1 || snapshotBotNear) && !this.isPublicMap()) || (c.mapID != this.mapID && (c.isBot == -1 || snapshotBotNear)) || (c.mapID == this.mapID && c.region != this.region)) {
                        this.nearChars.remove(j);
                        this.charOutRange(c);
                    } else {
                        final boolean near = this.near(c, this.rangeAddMonster[0]);
                        if ((near && (c.isBot != -1 || snapshotBotNear)) || ((this.checkInParty(c) || givcard) && !c.isAdmin)) {
                            boolean send = true;
        ...
        if (this.map.mapIDLoadMap == 0 || this.map.mapIDLoadMap == 70 || this.map.mapIDLoadMap == 80) {
            ...
            for (int i = 0; i < Map.npcVilage.size(); ++i) {
                if (!TeamServer.isServerIndo()) {
                    ...
                    if (this.near(this.x, this.y, xx, yy, actorDisplayRange)) {
        ...
        if (!this.map.isDun()) {
            ...
            for (int k = players.size() - 1; k >= 0; --k) {
                try {
                    ...
                    if (p1 != null) {
                        ...
                        final boolean snapshotBotNear = AmbientBotManager.isAmbientBot(p1) || LuongSon108Manager.isGuardBot(p1);
                        if (this != p1) {
                            if ((p1.mapID != this.mapID && (p1.isBot == -1 || snapshotBotNear)) || (p1.mapID == this.mapID && p1.region != this.region) || ((p1.isBot == -1 || snapshotBotNear) && p1.inCountry != this.inCountry && !this.isPublicMap())) {
                                ...
                                if (!this.nearChars.contains(p1.id)) {
                                    if (this.nearChars.size() - this.nNpc < this.nNearchar || p1.pk != 0 || p1.isKiller || this.checkInParty(p1) || p1.isBot != -1 || this.mapID == Map.idMapDautruong || this.map.isMapChienTruongMoba() || (this.mapID == Map.idMapTown && (Map.nwar[this.myCountry] || Map.getTown[this.myCountry]))) {
                                        ...
                                        if ((near2 && p1.inCountry == this.inCountry) || (this.isPublicMap() && near2) || (p1.isBot != -1 && !snapshotBotNear)) {
                                            ...
                                            if (p1.isBot != -1 && !snapshotBotNear) {
                                                ++this.nNpc;
                                            }
                                            this.nearChars.add(p1.id);
                                        }
                                    }
                                } else if (!this.near(p1, this.rangeRemoveMonster[0]) && !this.checkInParty(p1) && (p1.isBot == -1 || snapshotBotNear) && !givcard2) {
            ...
            if (havedata) {
                ...
                for (int i = 0; i < snapshotBots.size(); ++i) {
                    final Char snapshotBot = snapshotBots.get(i);
                    AmbientBotManager.sendAmbientSnapshot(this, snapshotBot);
                }
            }
        }
    }
    ...
    private void updateHoangCtSameMapFollow() {
        final int followerIndex = this.getHoangCtFollowerIndex();
        if (followerIndex < 0 || this.map == null || this.getSession() == null || this.hp <= 0 || this.isDoChangeMap) {
            return;
        }
        final long now = System.currentTimeMillis();
        if (now - this.timeHoangCtFollow < HOANG_CT_FOLLOW_INTERVAL) {
            return;
        }
        this.timeHoangCtFollow = now;
        if (this.beStune || this.freeze() || this.isStune() || this.isHoangLoan() || this.map.givingCard(this)) {
            return;
        }
        final Char leader = this.findHoangCtLeader();
        if (leader == null || leader == this || leader.map != this.map || leader.region != this.region || leader.getSession() == null || leader.hp <= 0) {
            return;
        }
        final int targetX = leader.x + HOANG_CT_FOLLOW_OFFSETS[followerIndex][0];
        final int targetY = leader.y + HOANG_CT_FOLLOW_OFFSETS[followerIndex][1];
        this.moveHoangCtFollowerToward(targetX, targetY);
    }

    private int getHoangCtFollowerIndex() {
        final String accountName = this.getCurrentAccountName();
        if (accountName == null) {
            return -1;
        }
        for (int i = 0; i < HOANG_CT_FOLLOWER_ACCOUNTS.length; ++i) {
            if (HOANG_CT_FOLLOWER_ACCOUNTS[i].equals(accountName)) {
                return i;
            }
        }
        return -1;
    ...
    private String getCurrentAccountName() {
        if (this.getSession() == null || this.getSession().username == null) {
            return null;
        }
        return this.getSession().username.trim().toLowerCase();
    }

    public boolean hasEscortTestAccess() {
        if (this.charname != null && ESCORT_TEST_ACCOUNT.equalsIgnoreCase(this.charname.trim())) {
            return true;
        }
        final String accountName = this.getCurrentAccountName();
        if (ESCORT_TEST_ACCOUNT.equals(accountName)) {
            return true;
        }
        final Session currentSession = this.getSession();
        return currentSession != null
                && currentSession.usernameReg != null
                && ESCORT_TEST_ACCOUNT.equals(currentSession.usernameReg.trim().toLowerCase());
    }

    private boolean isHoangCtLeaderAccount() {
        final String accountName = this.getCurrentAccountName();
        if (HOANG_CT_LEADER_ACCOUNT.equals(accountName)) {
            return true;
        }
        final Session currentSession = this.getSession();
        return currentSession != null
                && currentSession.usernameReg != null
                && HOANG_CT_LEADER_ACCOUNT.equals(currentSession.usernameReg.trim().toLowerCase());
    }

    public boolean hasHoangCtAbsoluteDefenseBuff() {
        return this.isHoangCtLeaderAccount();
    }

    public int clampIncomingDamageForHoangCt(final int damage) {
        if (!this.hasHoangCtAbsoluteDefenseBuff() || damage <= 0) {
            return damage;
        }
        return 1;
    }

    private int getHoangCtReflectDamage(final int damage) {
        if (!this.hasHoangCtAbsoluteDefenseBuff() || damage <= 0) {
            return 0;
        }
        if (damage >= Integer.MAX_VALUE / 2) {
            return Integer.MAX_VALUE;
        }
        return damage * 2;
    }

    private Char findHoangCtLeader() {
        for (int i = 0; i < CharManager.instance.vChars.size(); ++i) {
            final Char player = (Char) CharManager.instance.vChars.elementAt(i);
            if (player != null && player.getSession() != null && player.getSession().username != null
                    && HOANG_CT_LEADER_ACCOUNT.equals(player.getSession().username.trim().toLowerCase())) {
                return player;
            }
        }
        return null;
    ...
    private void moveHoangCtFollowerToward(final int targetX, final int targetY) {
        if (Map.abs(this.x - targetX) <= HOANG_CT_FOLLOW_NEAR && Map.abs(this.y - targetY) <= HOANG_CT_FOLLOW_NEAR) {
            return;
        }
        int nextX = this.x;
        int nextY = this.y;
        if (targetX > this.x) {
            nextX += Math.min(HOANG_CT_FOLLOW_STEP, targetX - this.x);
        } else if (targetX < this.x) {
            nextX -= Math.min(HOANG_CT_FOLLOW_STEP, this.x - targetX);
        }
        if (targetY > this.y) {
            nextY += Math.min(HOANG_CT_FOLLOW_STEP, targetY - this.y);
        } else if (targetY < this.y) {
            nextY -= Math.min(HOANG_CT_FOLLOW_STEP, this.y - targetY);
        }
        if (this.tryHoangCtFollowMove(nextX, nextY)) {
            return;
        }
        if (this.tryHoangCtFollowMove(nextX, this.y)) {
            return;
        }
        this.tryHoangCtFollowMove(this.x, nextY);
    }

    private boolean tryHoangCtFollowMove(final int targetX, final int targetY) {
        if (targetX == this.x && targetY == this.y) {
            return false;
        }
        if (!this.canHoangCtFollowMoveTo(targetX, targetY)) {
            return false;
        }
        this.applyHoangCtFollowMove(targetX, targetY);
        return true;
    }

    private boolean canHoangCtFollowMoveTo(final int targetX, final int targetY) {
        if (this.map == null || !this.map.canMove(targetX, targetY)) {
            return false;
        }
        if (this.map.mapId == Map.idMapTown && Map.getTown[this.inCountry] && !MapTown.congthanh.get(this.inCountry).isDead && !this.isAdmin && targetY < 1206) {
            return false;
        }
        ...
        if (Map.abs(this.x - targetX) > distance || Map.abs(this.y - targetY) > distance) {
            return false;
        }
        ...
        p2.x1 = targetX / 16;
        p2.y1 = targetY / 16;
        return this.checkToPoint(p1, p2);
    }

    private void applyHoangCtFollowMove(final int targetX, final int targetY) {
        final long now = System.currentTimeMillis();
        this.isThodia = false;
        this.timeMove = now;
        this.timeLastMove = now;
        this.lastMovex = 0;
        this.lastMovey = 0;
        this.x = targetX;
        this.y = targetY;
        this.moved = true;
        this.sendHoangCtFollowMoveUpdate();
        if (this.charthanthu != null && (Map.abs(this.x - this.charthanthu.x) > 48 || Map.abs(this.y - this.charthanthu.y) > 48)) {
            this.charthanthu.setXtoYto(targetX, targetY);
        }
        if (this.charCopy != null) {
            this.charCopy.setXtoYto(targetX, targetY);
        }
        if (this.charHire != null && !Map.inRangeActor(this, this.charHire, 60)) {
            this.charHire.setXtoYto(targetX, targetY);
        }
    }

    private void sendHoangCtFollowMoveUpdate() {
        try {
            final Message moveMessage = new Message(4);
            this.writeActorPos(moveMessage, this);
            this.sendMessage(moveMessage);
            final Vector<Char> players = this.map.getAllPlayer(this.inCountry, this.region);
            for (int i = 0; i < players.size(); ++i) {
                final Char player = players.get(i);
    ...
    private boolean hasUsableTimedItem(final Vector<Item> items, final int templateId) {
        if (items == null) {
            return false;
        }
        for (int i = 0; i < items.size(); ++i) {
            final Item item = items.elementAt(i);
            if (item == null || item.tempateID != templateId || item.isHetHan()) {
                continue;
            }
            return true;
        }
    ...
    public boolean checkItemTheMuaBan() {
        return this.hasUsableTimedItem(this.iItems, Item.THE_MUA_BAN)
                || this.hasUsableTimedItem(this.bagItems, Item.THE_MUA_BAN)
                || this.hasUsableTimedItem(this.bItem, Item.THE_MUA_BAN);
    }

    private boolean canAutoVisitHacNguuByTheMuaBan() {
        return this.checkItemTheMuaBan()
                && this.map != null
                && !this.map.isMapOffline
                && !Map.getTown[this.inCountry]
                && this.monster == null
                && this.canUseTheMuaBan();
    }

    public String autoVisitHacNguuByTheMuaBan() {
        if (!this.canAutoVisitHacNguuByTheMuaBan()) {
            return "";
        }
        final int returnMapId = this.mapID;
        final short returnRegion = (short) this.region;
        final byte returnX = (byte) (this.x / 16);
        final byte returnY = (byte) (this.y / 16);
        final byte returnCountry = this.inCountry;
        this.map.move2Map(this, 5, 5, 103, returnCountry);
        final long soldXu = this.autoSellUpItemsByTheMuaBan();
        final boolean repairedWeapon = this.needRepairWeapon()
                && this.getPriceRepair(1) > 0
                && this.getxu() >= this.getPriceRepair(1);
        if (repairedWeapon) {
            this.repairItem(0);
        }
        if (this.map != null && this.map.isMapOffline) {
            this.region = returnRegion;
            this.map.move2Map(this, returnX, returnY, returnMapId, returnCountry);
        }
        if (soldXu <= 0L && !repairedWeapon) {
            return "";
        }
        this.sendMessage(MessageCreator.createCharInventoryMessage(this, 0));
        this.sendMessage(MessageCreator.createCharInventoryMessage(this, 1));
        String info = "";
        if (soldXu > 0L) {
            info = "The mua ban da vao Hac Nguu ban do up, nhan " + soldXu + " xu";
        }
        if (repairedWeapon) {
            info = info.isEmpty() ? "The mua ban da vao Hac Nguu sua vu khi" : info + ", sua vu khi";
        }
        return info;
    }

    private boolean canAutoSellUpItemByTheMuaBan(final Item item) {
        if (item == null || item.getTemplate() == null) {
            return false;
        }
        if (item.tempateID == Item.THE_MUA_BAN || item.isSelling || item.prizeSell > 0 || item.idSellMarket > 0) {
            return false;
        }
        final int type = item.getTemplate().type;
        if (!Map.isItemChar(type) || item.isItemDrop == 0) {
            return false;
        }
        if (item.isHacLang() || item.isThanNu() || item.isChoiSell()) {
            return false;
        }
        if ((item.getTemplate().ndayLoan > 0
                || Map.isItemThanThu(type)
                || item.isChoiLuaLanBienHinh()
                || ItemLuckyDraw.isChoi(item.getTemplate().id))
                && !Map.isTheBaiLinhDanhThue(type)) {
            return false;
        }
        return !Map.isTheBaiMuaban(type) && !Map.isItemVantieu(type) && !Map.isItemTangTocVanTieu(type);
    }

    public long autoSellUpItemsByTheMuaBan() {
        long totalXu = 0L;
        final Vector<Item> itemsToSell = new Vector<Item>();
        for (int i = 0; i < this.iItems.size(); ++i) {
            final Item item = this.iItems.elementAt(i);
            if (this.canAutoSellUpItemByTheMuaBan(item)) {
                itemsToSell.add(item);
            }
        }
        for (int i = 0; i < itemsToSell.size(); ++i) {
            final Item item = itemsToSell.elementAt(i);
            if (!this.iItems.remove(item)) {
                continue;
            }
            if (item.dbid != 0) {
                Database.instance.deleteItem(item.dbid);
            ...
            xu += xu * (long) Char.up_px_xu_vip[this.vip] / 100L;
            totalXu += xu;
            this.removeIDItem(item.id);
            Database.instance.saveLogItemSellShop(
                    this.charname,
                    this.charDBID,
                    this.lvDetail.lv
                            + " AUTO ITEM + "
        ...
        if (totalXu > 0L) {
            this.addXu(totalXu, "the_muaban_auto_sell");
        }
        return totalXu;
    }

    public boolean needRepairWeapon() {
        final Vector<Item> wItems = this.getCharWearing();
        for (int i = 0; i < wItems.size(); ++i) {
            final Item item = wItems.elementAt(i);
            if (item == null || item.getTemplate() == null) {
                continue;
            }
            final int type = item.getTemplate().type;
            if ((type == 6 || type == 7 || type == 4 || type == 5 || type == 3)
                    && item.getTemplate().durable > 0
                    && item.durable < item.getTemplate().durable) {
                return true;
            }
        }
    ...
    public void subUpdate() {
        ...
        if (this.vip > 0 && Map.ALL_CHAR_VIP.get(this.charname) == null) {
            this.vip = 0;
            try {
                this.calculateAttrib();
                this.sendMessage(MessageCreator.createMainCharInfoMessage(this));
        ...
        this.ensureLuckyBagResetBySchedule();
        if (!this.dayLogin.equals(getDayResetOpen())) {
            this.countnvVulan = 0;
            this.maxKill = 0;
            this.usingSummons = 0;
            this.dayLogin = getDayResetOpen();
            this.countQuestClan = 0;
            this.pointActiveQuest += 100;
            this.receiveQuestVulan = 0;
            this.receiveGiftEvent = 0;
...
//            }
        ...
        if (!this.map.isDun() && this.isBot == -1) {
            for (int j = 0; j < this.nearMons.size(); ++j) {
                ...
                if (mt != null) {
                    if (mt instanceof KhaBanhBoss || mt instanceof KhaBanhMinion) {
                    ...
                    if (mt.isDead || !this.near(mt, this.rangeRemoveMonster[0])) {
                        ...
                        if ((this.near(mt, this.map.isvanTienTran() ? 240 : 120) || mt.isBoss || mt.idTemplate == 83) && this.hp > 0 && mt.target == null && mt.canAutoAttackPlayer() && !this.isAdmin && mt.isEnemy(this)) {
    ...
    public Message writeActorPos(final Message m, final Actor a) {
        try {
            m.dos.writeByte(a.cat);
            byte actorType = (byte) a.getType();
            boolean snapshotActor = a.cat == 0 && AmbientBotManager.usesPlayerSnapshot((Char) a);
            if (snapshotActor) {
                actorType = AmbientBotManager.getDisplayActorType((Char) a);
            }
            m.dos.writeByte(actorType);
            m.dos.writeShort(a.id);
            short x = (short) a.x;
            short y = (short) a.y;
            if (a.cat == 0) {
    ...
    // Temporary high-damage override for the Khá Bảnh event test account.
    private int applyKhaBanhTestDamage(final LiveActor actor, int currentDamage) {
        if (!(actor instanceof KhaBanhBoss) && !(actor instanceof KhaBanhMinion)) {
            return currentDamage;
        }
        if (!this.isKhaBanhTestIdentity()) {
            return currentDamage;
        }
        if (actor.maxhp > currentDamage) {
            currentDamage = actor.maxhp;
        }
        return currentDamage;
    }

    private boolean isKhaBanhTestIdentity() {
        if (this.matchesKhaBanhTestKey(this.charname)) {
            return true;
        }
        final Session currentSession = this.getSession();
        return currentSession != null
                && (this.matchesKhaBanhTestKey(currentSession.username)
                || this.matchesKhaBanhTestKey(currentSession.usernameReg));
    }
    ...
    public void sendInviteParty2User(final Message m) {
        try {
            ...
            if (fr != null) {
                ...
                if (AmbientBotManager.isAmbientBot(fr)) {
                    AmbientBotManager.handlePartyInvite(this, fr);
                    return;
                }
        ...
        try {
            if (this.userTrade.size() == 1) {
                try {
                    ...
                    this.userTrade.get(0).resetTradeData();
    ...
    public String getInfoAnimal() {
        return this.getAnimalInfoForClient(this.animalRide);
    }

    public String getAnimalInfoForClient(final Animal animal) {
        this.ensureHideExpireAnimalDbIdsSynced();
        if (animal == null) {
            return "";
        }
        final String info = animal.getInfoSendUser();
        if (!this.shouldHideAnimalExpireClient(animal) || animal.texpire <= 0L) {
            return info;
        }
        final int lastLine = info.lastIndexOf('\n');
        return lastLine >= 0 ? info.substring(0, lastLine) : info;
    }

    public boolean shouldHideAnimalExpireClient(final Animal animal) {
        return animal != null
                && animal.dbid > 0
                && this.hideExpireAnimalDbIds.contains(Integer.valueOf(animal.dbid));
    }

    private boolean isCurrentAnimalDbId(final int dbid) {
        if (dbid <= 0) {
            return false;
        }
        for (int i = 0; i < this.animal.size(); ++i) {
            final Animal animal = this.animal.get(i);
            if (animal != null && animal.dbid == dbid) {
                return true;
            }
        }
        return false;
    ...
    private boolean shouldSyncHideAnimalExpireClient(final Animal animal) {
        return animal != null
                && animal.dbid > 0
                && animal.texpire > 0L
                && (animal.isPhuongHoangLua() || animal.isPhuongHoangBang())
                && Database.instance.isGioToTimedPhoenixRide(animal, this.charname);
    }

    public void ensureHideExpireAnimalDbIdsSynced() {
        if (this.hideExpireAnimalDbIdsSynced) {
            return;
        }
        boolean changed = false;
        try {
            for (int i = this.hideExpireAnimalDbIds.size() - 1; i >= 0; --i) {
                if (!this.isCurrentAnimalDbId(this.hideExpireAnimalDbIds.get(i))) {
                    this.hideExpireAnimalDbIds.remove(i);
                    changed = true;
                }
            }
            for (int i = 0; i < this.animal.size(); ++i) {
                final Animal animal = this.animal.get(i);
                if (this.shouldHideAnimalExpireClient(animal)) {
                    continue;
                }
                if (this.shouldSyncHideAnimalExpireClient(animal)) {
                    this.markHideAnimalExpireClient(animal);
                    changed = true;
                }
            }
            this.hideExpireAnimalDbIdsSynced = true;
            if (changed) {
                Database.instance.saveChar(this, false);
            }
        } catch (final Exception ex) {
    ...
    public void markHideAnimalExpireClient(final Animal animal) {
        if (animal == null || animal.dbid <= 0) {
            return;
        }
        final Integer dbid = Integer.valueOf(animal.dbid);
        if (!this.hideExpireAnimalDbIds.contains(dbid)) {
            this.hideExpireAnimalDbIds.add(dbid);
        }
    }

    private boolean removeHideAnimalExpireClient(final Animal animal) {
        return animal != null
                && animal.dbid > 0
                && this.hideExpireAnimalDbIds.removeElement(Integer.valueOf(animal.dbid));
    }

    private String serializeHideExpireAnimalDbIds() {
        if (this.hideExpireAnimalDbIds == null || this.hideExpireAnimalDbIds.isEmpty()) {
            return "";
        }
        final StringBuilder builder = new StringBuilder();
        for (int i = 0; i < this.hideExpireAnimalDbIds.size(); ++i) {
            final int dbid = this.hideExpireAnimalDbIds.get(i);
            if (dbid <= 0) {
                continue;
            }
            if (builder.length() > 0) {
    ...
    private void parseHideExpireAnimalDbIds(final String data) {
        this.hideExpireAnimalDbIds.removeAllElements();
        if (data == null || data.trim().equals("")) {
            return;
        }
        final String[] entries = split(data, ";");
        for (int i = 0; i < entries.length; ++i) {
            try {
                ...
                final Integer dbid = Integer.valueOf(Integer.parseInt(entry));
                if (dbid.intValue() > 0 && !this.hideExpireAnimalDbIds.contains(dbid)) {
                    this.hideExpireAnimalDbIds.add(dbid);
                }
            } catch (final Exception ex) {
            }
    ...
    public String getDBInfo() {
        this.updateOnlineNongDanTime();
        this.cleanupGioToPhoenixEggs();
        ...
        pInfo = String.valueOf(pInfo) + "," + this.countBaoMayManOpen;
        pInfo = String.valueOf(pInfo) + "," + this.luongBaoMayManDay;
        pInfo = String.valueOf(pInfo) + "," + this.luongKhoaBaoMayManDay;
        pInfo = String.valueOf(pInfo) + "," + this.timeReduceDurability;
        pInfo = String.valueOf(pInfo) + "," + this.loginCompensationVersion;
        pInfo = String.valueOf(pInfo) + "," + this.diemNongDan;
        pInfo = String.valueOf(pInfo) + "," + this.soHopQuaNongDanNgay;
        pInfo = String.valueOf(pInfo) + "," + this.timeDat50HopQuaNongDan;
        pInfo = String.valueOf(pInfo) + "," + this.dayLuckyBagReset;
        pInfo = String.valueOf(pInfo) + "," + this.timeExpLock;
        pInfo = String.valueOf(pInfo) + "," + this.timeOnlineNongDanNgay;
        pInfo = String.valueOf(pInfo) + "," + this.choDenSoLanTieuTimConLai;
        pInfo = String.valueOf(pInfo) + "," + this.choDenKyDaMuaManh;
        pInfo = String.valueOf(pInfo) + "," + this.choDenSoManhDaMua;
        pInfo = String.valueOf(pInfo) + "," + this.serializeGioToPhoenixEggExpireQueue(this.gioToPhoenixLuaEggExpires);
        pInfo = String.valueOf(pInfo) + "," + this.serializeGioToPhoenixEggExpireQueue(this.gioToPhoenixBangEggExpires);
        pInfo = String.valueOf(pInfo) + "," + this.serializeHideExpireAnimalDbIds();
                ...
                if (item.getMinuteLoan(false) <= 0 && item.minuteExist > 0) {
                    ...
                    if (item.isChoiSell() && this.lastLog.compareTo("2019-11-29 10:50:00") < 0 && !this.charname.equals(Char.chartopchoitrungthu) && item.dogetbackChoiDuaTop()) {
                        ...
                        if (!Map.openLog && TeamServer.server == 5 && this.lastLog.compareTo("2018-03-12 11:25:00") < 0 && Map.isItemThanThu(item.getTemplate().type)) {
                            ...
                            item.rebuildLowTierCraftedBaseStats();
...
//                    }
                    ...
                    if (data.length > 112) {
                        this.countBaoMayManOpen = Integer.parseInt(data[112]);
                        if (this.countBaoMayManOpen < 0) {
                            this.countBaoMayManOpen = 0;
                        } else if (this.countBaoMayManOpen > 1000) {
                            this.countBaoMayManOpen = 1000;
                        }
                    }
                    if (data.length > 113) {
                        this.luongBaoMayManDay = Integer.parseInt(data[113]);
                        if (this.luongBaoMayManDay < 0) {
                            this.luongBaoMayManDay = 0;
                        }
                    }
                    if (data.length > 114) {
                        this.luongKhoaBaoMayManDay = Integer.parseInt(data[114]);
                        if (this.luongKhoaBaoMayManDay < 0) {
                            this.luongKhoaBaoMayManDay = 0;
                        }
                    }
                    if (data.length > 115) {
                        this.timeReduceDurability = Long.parseLong(data[115]);
                    }
                    if (data.length > 116) {
                        this.loginCompensationVersion = Integer.parseInt(data[116]);
                    }
                    if (data.length > 117) {
                        this.diemNongDan = Integer.parseInt(data[117]);
                        if (this.diemNongDan < 0) {
                            this.diemNongDan = 0;
                        }
                    }
                    if (data.length > 118) {
                        this.soHopQuaNongDanNgay = Integer.parseInt(data[118]);
                        if (this.soHopQuaNongDanNgay < 0) {
                            this.soHopQuaNongDanNgay = 0;
                        } else if (this.soHopQuaNongDanNgay > getLuckyBagFarmLimitPerDay()) {
                            this.soHopQuaNongDanNgay = getLuckyBagFarmLimitPerDay();
                        }
                    }
                    if (data.length > 119) {
                        this.timeDat50HopQuaNongDan = Long.parseLong(data[119]);
                        if (this.timeDat50HopQuaNongDan < 0L) {
                            this.timeDat50HopQuaNongDan = 0L;
                        }
                    }
                    if (data.length > 120) {
                        this.dayLuckyBagReset = data[120].trim();
                    }
                    if (data.length > 121) {
                        final long savedExpLock = Long.parseLong(data[121]);
                        if (savedExpLock <= 1L) {
                            this.timeExpLock = (savedExpLock == 1L) ? (System.currentTimeMillis() + EXP_LOCK_MINUTES * 60000L) : 0L;
                        } else {
                            this.timeExpLock = savedExpLock;
                        }
                        if (this.timeExpLock < System.currentTimeMillis()) {
                            this.timeExpLock = 0L;
                        }
                    }
                    if (data.length > 122) {
                        this.timeOnlineNongDanNgay = Long.parseLong(data[122]);
                        if (this.timeOnlineNongDanNgay < 0L) {
                            this.timeOnlineNongDanNgay = 0L;
                        }
                    }
                    if (data.length > 123) {
                        this.choDenSoLanTieuTimConLai = Byte.parseByte(data[123]);
                        if (this.choDenSoLanTieuTimConLai < 0) {
                            this.choDenSoLanTieuTimConLai = 0;
                        }
                    }
                    if (data.length > 124) {
                        this.choDenKyDaMuaManh = Integer.parseInt(data[124]);
                    }
                    if (data.length > 125) {
                        this.choDenSoManhDaMua = Byte.parseByte(data[125]);
                        if (this.choDenSoManhDaMua < 0) {
                            this.choDenSoManhDaMua = 0;
                        }
                    }
                    if (data.length > 126) {
                        this.parseGioToPhoenixEggExpireQueue(data[126], this.gioToPhoenixLuaEggExpires);
                    }
                    if (data.length > 127) {
                        this.parseGioToPhoenixEggExpireQueue(data[127], this.gioToPhoenixBangEggExpires);
                    }
                    if (data.length > 128) {
                        this.parseHideExpireAnimalDbIds(data[128]);
                    }
                    if (this.soHopQuaNongDanNgay >= getLuckyBagFarmLimitPerDay() && this.timeDat50HopQuaNongDan > 0L) {
                        this.lastTimeOnlineNongDanTick = System.currentTimeMillis();
                    } else {
                        this.lastTimeOnlineNongDanTick = 0L;
                    }
                } catch (final Exception ex8) {
                ...
                if (this.hasDurabilityBlessing()) {
                    try {
                        this.sendMessage(MessageCreator.createServerAlertAutoOffMessage("Bùa chống hao mòn còn lại " + this.getRemainDurabilityBlessingMinute() + " phút"));
                    } catch (final IOException ex11) {
                    }
                }
                if (this.isExpLocked()) {
                    try {
                        this.sendMessage(MessageCreator.createServerAlertAutoOffMessage("Thẻ khóa EXP đang hoạt động. Còn lại " + this.getRemainExpLockMinute() + " phút."));
                    } catch (final IOException ex11) {
                    }
                }
            } catch (final Exception ex12) {
        ...
        try {
            ...
            try {
                ...
                if (this.char_quest != null) {
                    ...
                    if (this.itquest != null && !this.itquest.equals("")) {
                        final String[] data = split(this.itquest, ",");
                        for (int i = 0; i < data.length; ++i) {
                            this.itemquest[i] = Short.parseShort(data[i]);
                        }
                    }
                    if (this.isBrokenFreshMainQuest()) {
                        final short brokenQuest = this.mainQuest.id_quest;
                        final short brokenIdMainQuest = this.idMainQuest;
                        this.resetBrokenFreshMainQuest();
                        Database.instance.saveCharQuest(this.charDBID, this.getInfoQuestSave());
                        Database.instance.saveOrtherLog("", this.charname, brokenQuest + "," + brokenIdMainQuest, "fix_new_char_quest");
                    }
                    if (this.itemget.equals("") && this.monskilled.equals("") && this.finish.equals("")) {
                        Database.instance.addCharQuest(this.charDBID, this.getInfoQuestSave());
                    }
                }
            } catch (final Exception ex2) {
            ...
            if (this.getSession() != null && Map.hasFixedAdminAccess(this.getSession().username)) {
                this.isAdmin = true;
            }
            ...
            if (this.dbSkill != null) {
                ...
                // Basic attack is innate. Repair legacy/fresh rows that stored it
                // at level 0 so the player cannot become combat-locked.
                if (this.skill[0] == 0) {
                    this.skill[0] = 1;
                }
            }
            ...
            if (Map.ALL_CHAR_VIP.get(this.charname) == null) {
                this.vip = 0;
                this.rcvInviteVip = true;
            } else {
                final int a = Map.ALL_CHAR_VIP.get(this.charname);
                this.vip = (byte) a;
            }
            this.ensureLuckyBagResetBySchedule();
            if (!this.dayLogin.equals(getDayResetOpen())) {
...
//        }
    ...
    private static int getLuckyBagValue(int index, int fallbackMin, int fallbackMax) {
        int min = fallbackMin;
        int max = fallbackMax;
        if (Map.luckyBagRewardMin != null && Map.luckyBagRewardMin.length > index) {
            min = Map.luckyBagRewardMin[index];
        }
        if (Map.luckyBagRewardMax != null && Map.luckyBagRewardMax.length > index) {
            max = Map.luckyBagRewardMax[index];
        }
        if (max < min) {
            int tmp = min;
            min = max;
        ...
        return min + Map.r.nextInt(max - min + 1);
    }

    private static int getLuckyBagRewardType() {
        int[] useWeights = new int[5];
        if (Map.luckyBagRewardWeights != null) {
            int len = Math.min(Map.luckyBagRewardWeights.length, useWeights.length);
            for (int i = 0; i < len; i++) {
                useWeights[i] = Math.max(0, Map.luckyBagRewardWeights[i]);
            }
        }
        int type = getIndexRandom(useWeights);
        if (type < 0 || type >= useWeights.length) {
            type = Map.r.nextInt(useWeights.length);
        }
        return type;
    }

    public void reviveAtCurrentSpot() {
        this.hp = this.maxhp;
        this.mp = this.maxmp;
        this.timeHs = Char.timeAddMoreHs;
        this.timeHoiSinh = 0L;
    ...
    public void doOpenTuiQuaMayManNoel() {
        this.doOpenBaoMayManDaily();
    }

    private void resetDailyLuckyBagCounters() {
        this.countBaoMayManOpen = 0;
        this.luongBaoMayManDay = 0;
        this.luongKhoaBaoMayManDay = 0;
        this.soHopQuaNongDanNgay = 0;
    ...
    public static void configureLuckyBagDailyReset(final int hour, final int minute) {
        luckyBagResetHour = Math.max(0, Math.min(23, hour));
        luckyBagResetMinute = Math.max(0, Math.min(59, minute));
    }

    private static String getLuckyBagResetKey() {
        final Calendar cal = Calendar.getInstance();
        final int currentHour = cal.get(11);
        final int currentMinute = cal.get(12);
        if (currentHour < luckyBagResetHour || (currentHour == luckyBagResetHour && currentMinute < luckyBagResetMinute)) {
            cal.add(5, -1);
        }
        return UserLogger.dateFormat.format(cal.getTime());
    }

    public static String getCurrentLuckyBagResetKey() {
        return getLuckyBagResetKey();
    }

    private void ensureLuckyBagResetBySchedule() {
        final String resetKey = getLuckyBagResetKey();
        if (this.dayLuckyBagReset == null || this.dayLuckyBagReset.isEmpty() || this.dayLuckyBagReset.compareTo(resetKey) < 0) {
            this.resetDailyLuckyBagCounters();
            this.dayLuckyBagReset = resetKey;
        }
    }

    public synchronized int forceResetLuckyBagDaily(final String resetKey) {
        int removedLuckyBags = 0;
        if (this.potions != null && this.potions.length > Potion.TYPE_TUI_QUA_MAY_MAN_NOEL) {
            if (this.potions[Potion.TYPE_TUI_QUA_MAY_MAN_NOEL] > 0) {
                removedLuckyBags = this.potions[Potion.TYPE_TUI_QUA_MAY_MAN_NOEL];
            }
            this.potions[Potion.TYPE_TUI_QUA_MAY_MAN_NOEL] = 0;
        }
        this.resetDailyLuckyBagCounters();
        this.dayLuckyBagReset = (resetKey == null || resetKey.trim().isEmpty()) ? getLuckyBagResetKey() : resetKey.trim();
        return removedLuckyBags;
    }

    public static int getLuckyBagFarmLimitPerDay() {
        return MAX_HOP_QUA_NONG_DAN_NGAY;
    }

    public static int getLuckyBagOpenLimitPerDay() {
        int limit = Map.luckyBagMaxOpenPerDay;
        if (limit <= 0) {
            limit = DEFAULT_LUCKY_BAG_OPEN_LIMIT_PER_DAY;
        }
        return limit;
    }

    public static String getLuckyBagFarmReachedMessage() {
        return "Da nhat du " + MAX_HOP_QUA_NONG_DAN_NGAY
                + " hop qua vao hanh trang hom nay. Bat dau tinh 3 gio online cong don trong ngay. Danh quai lech toi da 5 cap se nhan "
                + Map.DIEM_NONG_DAN_MOI_QUAI
                + " Diem nong dan moi quai, du 3 gio se nhan "
                + Map.DIEM_NONG_DAN_MOI_QUAI_SAU_3H
                + " Diem nong dan moi quai.";
    }

    public static String getLuckyBagOpenReachedMessage() {
        return "Da mo du " + getLuckyBagOpenLimitPerDay()
                + " hop qua may man hom nay.";
    }

    private synchronized boolean daMoDuBaoMayManNongDanNgay() {
        this.ensureLuckyBagResetBySchedule();
        int maxOpen = getLuckyBagOpenLimitPerDay();
        if (this.countBaoMayManOpen < 0) {
            this.countBaoMayManOpen = 0;
        } else if (this.countBaoMayManOpen > maxOpen) {
            this.countBaoMayManOpen = maxOpen;
        }
        return this.countBaoMayManOpen >= maxOpen;
    }

    private synchronized long updateOnlineNongDanTime() {
        this.ensureLuckyBagResetBySchedule();
        if (!this.daDatTranHopQuaNongDanNgay()) {
            this.lastTimeOnlineNongDanTick = 0L;
            if (this.timeOnlineNongDanNgay < 0L) {
                this.timeOnlineNongDanNgay = 0L;
            }
        ...
        final long now = System.currentTimeMillis();
        if (this.timeDat50HopQuaNongDan <= 0L) {
            this.timeDat50HopQuaNongDan = now;
        }
        if (this.timeOnlineNongDanNgay < 0L) {
            this.timeOnlineNongDanNgay = 0L;
        }
        if (this.lastTimeOnlineNongDanTick <= 0L || this.lastTimeOnlineNongDanTick > now) {
            this.lastTimeOnlineNongDanTick = now;
            return 0L;
        }
        final long add = now - this.lastTimeOnlineNongDanTick;
        this.lastTimeOnlineNongDanTick = now;
        if (add <= 0L) {
            return 0L;
        }
        this.timeOnlineNongDanNgay += add;
        return add;
    }

    public synchronized long getTimeOnlineNongDanNgay() {
        this.updateOnlineNongDanTime();
        if (this.timeOnlineNongDanNgay < 0L) {
            this.timeOnlineNongDanNgay = 0L;
        }
        return this.timeOnlineNongDanNgay;
    }

    public synchronized boolean tryRegisterLuckyBagFarmDrop() {
        this.ensureLuckyBagResetBySchedule();
        int limit = getLuckyBagFarmLimitPerDay();
        if (this.soHopQuaNongDanNgay < 0) {
            this.soHopQuaNongDanNgay = 0;
        }
        if (this.soHopQuaNongDanNgay >= limit) {
            this.soHopQuaNongDanNgay = limit;
            return false;
        }
        ++this.soHopQuaNongDanNgay;
        if (this.soHopQuaNongDanNgay >= limit) {
            this.soHopQuaNongDanNgay = limit;
    ...
    public synchronized boolean doOpenBaoMayManDaily() {
        this.ensureLuckyBagResetBySchedule();
        int maxOpen = getLuckyBagOpenLimitPerDay();
        boolean hadReachedOpenCap = this.daMoDuBaoMayManNongDanNgay();
        if (this.countBaoMayManOpen >= maxOpen) {
            this.sendMessage(MessageCreator.createServerAlertMessage("Hom nay ban da mo du " + maxOpen + " bao may man.", ""));
            return false;
        }

        this.countBaoMayManOpen++;
        int type = getLuckyBagRewardType();
        String info = "Chuc mung ban nhan duoc ";
        if (type == 0) {
            int add = getLuckyBagValue(0, 1, 30);
            this.addLuongFromLuckyBag(add);
            this.luongBaoMayManDay += add;
            info = info + add + " luong";
        } else if (type == 1) {
            int add = getLuckyBagValue(1, 1, 30);
            this.addLuongLockFromLuckyBag(add);
            this.luongKhoaBaoMayManDay += add;
            info = info + add + " luong khoa";
        } else if (type == 2) {
            int addXu = getLuckyBagValue(2, 10000, 100000);
            this.addXu(addXu, "baoMayMan");
            info = info + addXu + " xu";
        } else if (type == 3) {
            int qty = getLuckyBagValue(3, 1, 3);
            this.potions[LUCKY_BAG_HP_POTION_ID] += qty;
            info = info + qty + " " + LoginHandler.PORTION_NAME[LUCKY_BAG_HP_POTION_ID];
        } else if (type == 4) {
            int qty = getLuckyBagValue(4, 1, 3);
            this.potions[LUCKY_BAG_MP_POTION_ID] += qty;
            info = info + qty + " " + LoginHandler.PORTION_NAME[LUCKY_BAG_MP_POTION_ID];
        }

        boolean reachedOpenCap = !hadReachedOpenCap && this.daMoDuBaoMayManNongDanNgay();

        // Persist each open so relog/restart cannot roll back the daily cap.
        Database.instance.saveCharAuto(this);
        this.sendMessage(MessageCreator.createCharInventoryMessage(this, 0));
        this.sendMessage(MessageCreator.createServerAlertMessage(info, ""));
        if (reachedOpenCap) {
            this.sendMessage(MessageCreator.createMsgChat(this.id, getLuckyBagOpenReachedMessage()));
        }
        Database.instance.saveOrtherLog("", this.charname, info, "baomayman");
        return true;
    }
    ...
    public static String getDayResetOpen() {
        return getDayOpen(DAILY_RESET_OFFSET);
    }
    ...
    private Vector<Long> getGioToPhoenixEggExpireQueue(final int potionId) {
        if (potionId == Potion.TYPE_PHUONG_HOANG) {
            return this.gioToPhoenixLuaEggExpires;
        }
        if (potionId == Potion.TYPE_PH_BANG) {
            return this.gioToPhoenixBangEggExpires;
        }
        return null;
    }

    private long getSoonestGioToPhoenixEggExpireAt(final Vector<Long> queue) {
        if (queue == null || queue.isEmpty()) {
            return 0L;
        }
        long expireAt = queue.get(0);
        for (int i = 1; i < queue.size(); ++i) {
            final long currentExpire = queue.get(i);
            if (currentExpire < expireAt) {
                expireAt = currentExpire;
            }
        }
        return expireAt;
    }

    private String serializeGioToPhoenixEggExpireQueue(final Vector<Long> queue) {
        if (queue == null || queue.isEmpty()) {
            return "";
        }
        final long now = System.currentTimeMillis();
        ...
        for (int i = 0; i < queue.size(); ++i) {
            final long expireAt = queue.get(i);
            if (expireAt <= now) {
                continue;
            }
            if (builder.length() > 0) {
    ...
    private void parseGioToPhoenixEggExpireQueue(final String data, final Vector<Long> queue) {
        ...
        for (int i = 0; i < entries.length; ++i) {
            try {
                final String entry = entries[i].trim();
                if (!entry.equals("")) {
                    final long expireAt = Long.parseLong(entry);
                    if (expireAt > 0L) {
                        queue.add(expireAt);
                    }
                }
    ...
    private int cleanupGioToPhoenixEggExpireQueue(final int potionId, final Vector<Long> queue) {
        if (queue == null) {
            return 0;
        }
        int removed = 0;
        ...
        if (removed > 0) {
            this.potions[potionId] = Math.max(0, this.potions[potionId] - removed);
        }
        while (queue.size() > this.potions[potionId]) {
            queue.remove(0);
        }
        return removed;
    }

    public int cleanupGioToPhoenixEggs() {
        int removed = 0;
        removed += this.cleanupGioToPhoenixEggExpireQueue(Potion.TYPE_PHUONG_HOANG, this.gioToPhoenixLuaEggExpires);
        removed += this.cleanupGioToPhoenixEggExpireQueue(Potion.TYPE_PH_BANG, this.gioToPhoenixBangEggExpires);
        return removed;
    }

    public long addGioToTimedPhoenixEgg(final int potionId, final int day) {
        final Vector<Long> queue = this.getGioToPhoenixEggExpireQueue(potionId);
        final long expireAt = System.currentTimeMillis() + day * 24L * 60L * 60000L;
        final int[] potions = this.potions;
        ++potions[potionId];
        if (queue != null) {
            queue.add(expireAt);
    ...
    public long consumeGioToTimedPhoenixEgg(final int potionId) {
        this.cleanupGioToPhoenixEggs();
        final Vector<Long> queue = this.getGioToPhoenixEggExpireQueue(potionId);
        if (queue == null || queue.isEmpty()) {
            return 0L;
        ...
        queue.remove(index);
        if (this.potions[potionId] > 0) {
            --this.potions[potionId];
        }
        return expireAt;
    }

    public long getGioToTimedPhoenixEggExpireAt(final int potionId) {
        this.cleanupGioToPhoenixEggs();
        return this.getSoonestGioToPhoenixEggExpireAt(this.getGioToPhoenixEggExpireQueue(potionId));
    }
    ...
    public void doAddGemItem(final int id, final int soluong, final boolean lock) {
        final boolean forceLock = id == GemTemplate.AN_HAC_THI;
        if (this.listGemitem[id] == 0 && this.listGemitemLock[id] == 0) {
            final GemItem g = new GemItem(id);
            g.ownerId = this.charDBID;
            g.realId = this.getIDItem();
    ...
    public void doAddGemItem(final int id) {
        this.doAddGemItem(id, 1, false);
    }

    public void resetDiemNongDanNgay() {
        this.soHopQuaNongDanNgay = 0;
        this.timeDat50HopQuaNongDan = 0L;
        this.timeOnlineNongDanNgay = 0L;
        this.lastTimeOnlineNongDanTick = 0L;
    ...
    public synchronized boolean daDatTranHopQuaNongDanNgay() {
        this.ensureLuckyBagResetBySchedule();
        int limit = getLuckyBagFarmLimitPerDay();
        if (this.soHopQuaNongDanNgay < 0) {
            this.soHopQuaNongDanNgay = 0;
    ...
    public synchronized int getDiemNongDanMoiQuai() {
        this.ensureLuckyBagResetBySchedule();
        if (!this.daDatTranHopQuaNongDanNgay()) {
            return 0;
        }
        if (this.getTimeOnlineNongDanNgay() >= THOI_GIAN_DIEM_NONG_DAN_GIAI_DOAN_DAU) {
            return Map.DIEM_NONG_DAN_MOI_QUAI_SAU_3H;
        }
        return Map.DIEM_NONG_DAN_MOI_QUAI;
    }
...
//        Char.allItemLuckyDraw.add(item2);
    ...
    public static boolean isSuKienNoel() 
    {
        ...
        final boolean auto = !TeamServer.isServerLocal() && !TeamServer.isServerLienDau()
                && daycheck.compareTo("2023-06-01 00:00:00") < 0;
        return TeamServer.evalEvent(TeamServer.evNoel, auto);
    }

    public static boolean isSuKienTetduonglich2024() 
    {
        return TeamServer.evalEvent(TeamServer.evTetDuongLich2024, TeamServer.isSuKienTetduonglich2024);
    }

    public static boolean isSuKienNoel2023() 
    {
        return TeamServer.evalEvent(TeamServer.evNoel2023, TeamServer.isSuKienNoel2023);
    }

    public static boolean isSuKienMiniNuiChauBau() {
        final String daycheck = getDayTime(0L);
        final boolean auto = daycheck.compareTo("2020-10-18 23:59:59") < 0;
        return TeamServer.evalEvent(TeamServer.evMiniNuiChauBau, auto);
    }

    public static boolean isSuKienMini() {
        final String daycheck = getDayTime(0L);
        final boolean auto = daycheck.compareTo("2020-07-11 10:00:00") < 0;
        return TeamServer.evalEvent(TeamServer.evMini, auto);
    }

    public static boolean isSuKienMiniChucNu() {
        final String daycheck = getDayTime(0L);
        final boolean auto = daycheck.compareTo("2024-08-30 23:59:00") < 0;
        return TeamServer.evalEvent(TeamServer.evMiniChucNu, auto);
    }

    public static boolean isFinishSuKienMiniChucNu() {
        final String daycheck = getDayTime(0L);
        final boolean auto = daycheck.compareTo("2024-08-31 10:00:00") >= 0;
        return TeamServer.evalEventFinished(TeamServer.evMiniChucNu, auto);
    }

    public static boolean isFinishAllSuKienMini() {
        final String daycheck = getDayTime(0L);
        final boolean auto = daycheck.compareTo("2020-07-11 10:00:00") > 0;
        return TeamServer.evalEventFinished(TeamServer.evMini, auto);
    }

    public static boolean isOpenDauGiaChoiBlackFriday() {
        final String daycheck = getDayTime(0L);
        final boolean auto = daycheck.compareTo("2022-07-13 10:00:00") >= 0
                && daycheck.compareTo("2023-07-21 23:59:59") < 0;
        return TeamServer.evalEvent(TeamServer.evBlackFriday, auto);
    }

    public static boolean isOpenSellBlackFriday() {
        final String daycheck = getDayTime(0L);
        final boolean auto = daycheck.compareTo("2023-07-13 10:00:00") >= 0
                && daycheck.compareTo("2023-07-15 00:00:00") < 0;
        return TeamServer.evalEvent(TeamServer.evBlackFriday, auto);
    }

    public static boolean isSuKienBlackFriday() {
        final String daycheck = getDayOpen(0L);
        final boolean auto = daycheck.equals("2020-11-25");
        return TeamServer.evalEvent(TeamServer.evBlackFriday, auto);
    }

    public static boolean isSuKien83() {
        final String daycheck = getDayTime(0L);
        final boolean auto = daycheck.compareTo("2020-03-08 23:59:59") < 0;
        final boolean autoWithFlag = TeamServer.isSuKien83 || auto;
        return TeamServer.evalEvent(TeamServer.evSuKien83, autoWithFlag);
    }

    public static boolean isSuKienTrainRoiLuong() {
        return false;
    }
    ...
    public static boolean isFinishAllSuKienHaloween2016() {
        final String daycheck = getDayTime(0L);
        final boolean auto = daycheck.compareTo("2020-11-01 00:00:00") >= 0;
        return TeamServer.evalEventFinished(TeamServer.evHaloween2016, auto);
    }

    public static boolean isSuKienHaloween2016() {
        final String daycheck = getDayTime(0L);
        final boolean auto = (TeamServer.isServerLocal() && daycheck.compareTo("2020-11-01 00:00:00") < 0)
                || daycheck.compareTo("2020-11-01 00:00:00") < 0;
        return TeamServer.evalEvent(TeamServer.evHaloween2016, auto);
    }
    ...
    public static boolean isSuKienTrungThul2016() {
        final String daycheck = getDayTime(0L);
        final boolean auto = TeamServer.isSuKienTrungThul2016
                || daycheck.compareTo("2023-05-15 00:00:00") < 0;
        return TeamServer.evalEvent(TeamServer.evTrungThu2016, auto);
    }
    ...
    public static boolean isFinishAllSuKienTrungThul2016() {
        final String daycheck = getDayTime(0L);
        final boolean auto = daycheck.compareTo("2023-10-15 00:00:00") > 0;
        return TeamServer.evalEventFinished(TeamServer.evTrungThu2016, auto);
    }

    public static boolean isFinishAllSuKienTet2017() 
    {
        return !isSuKienTet2017();
    }

    public static boolean isSuKienTet2017() 
    {
        return TeamServer.evalEvent(TeamServer.evTet2017, TeamServer.isSuKienTet2017);
    }
    ...
    {
        return TeamServer.evalEvent(TeamServer.evGioTo2016, TeamServer.isSuKienGioTo2016);
    }
    ...
    public static boolean isFinishAllSuKienNoel() {
        final String daycheck = getDayTime(0L);
        final boolean auto = TeamServer.isServerLienDau() || TeamServer.isServerLocal()
                || daycheck.compareTo("2023-06-01 00:00:00") >= 0;
        return TeamServer.evalEventFinished(TeamServer.evNoel, auto);
    }

    public static boolean isFinishAllSuKienGioTo2016() 
    {
        return !isSuKienGioTo2016();
    }
    ...
    public static boolean isSuKienWordcup2017() {
        final String daycheck = getDayTime(0L);
        final boolean auto = daycheck.compareTo("2024-07-25 10:00:00") < 0;
        return TeamServer.evalEvent(TeamServer.evWorldcup2017, auto);
    }

    public static boolean isSuKienHe2017() {
        final String daycheck = getDayTime(0L);
        final boolean auto = daycheck.compareTo("2024-08-01 10:00:00") < 0;
        return TeamServer.evalEvent(TeamServer.evHe2017, auto);
    }
      
    public static boolean isFinishAllSuKienHe2017() {
        final String daycheck = getDayTime(0L);
        final boolean auto = daycheck.compareTo("2024-08-01 10:00:00") > 0;
        return TeamServer.evalEventFinished(TeamServer.evHe2017, auto);
    }
    ...
    public void doFinishLuckyDraw() {
        try {
            ...
            Logger.logError(e, "logs/runtime/errorquayso.txt");
        }
    }
    ...
    private boolean isBrokenFreshMainQuest() {
        return this.lastLV <= 1 && this.lvDetail.getExp() <= 0L && (this.idMainQuest >= 9 || this.mainQuest.id_quest >= 9);
    }

    private void resetBrokenFreshMainQuest() {
        this.idMainQuest = 0;
        this.mainQuest = new NewCharQuest((short) 0, (byte) 0);
        this.subQuest = new NewCharQuest(true);
        this.clanQuestNew = new NewCharQuest(true);
        this.eventQuest = new NewCharQuest(true);
        Arrays.fill(this.itemquest, (short) 0);
    }
    ...
    private void addLuongInternal(final int luong) {
        this.luong += luong;
    }

    private void addLuongLockInternal(final int luong) {
        this.lockLuong += luong;
    }

    private String getBlockedMoneyCaller() {
        final StackTraceElement[] stack = Thread.currentThread().getStackTrace();
        for (final StackTraceElement element : stack) {
            final String className = element.getClassName();
            if (className.equals(Thread.class.getName()) || className.equals(Char.class.getName())) {
                continue;
            }
    ...
    private void logBlockedMoneyReward(final String moneyType, final int amount, final String source) {
        if (amount <= 0) {
            return;
        }
        Database.instance.saveOrtherLog(
            "",
            this.charname,
            moneyType + "|" + amount + "|" + source + "|" + this.getBlockedMoneyCaller(),
            "blocked_money_reward"
        );
    }

    public void addLuongFromLuckyBag(final int luong) {
        if (luong <= 0) {
            return;
        }
        this.addLuongInternal(luong);
    }

    public void addLuongLockFromLuckyBag(final int luong) {
        if (luong <= 0) {
            return;
        }
        this.addLuongLockInternal(luong);
    }

    public void addLuongFromNongDan(final int luong) {
        if (luong <= 0) {
            return;
        }
        this.addLuongInternal(luong);
    ...
    public void addLuongFromVanTieu(final int luong) {
        if (luong <= 0) {
            return;
        }
        this.addLuongInternal(luong);
    ...
    public void addLuongFromLuongSonEvent(final int luong) {
        if (luong <= 0) {
            return;
        }
        this.addLuongInternal(luong);
    ...
    public void addLuongLockFromNongDan(final int luong) {
        if (luong <= 0) {
            return;
        }
        this.addLuongLockInternal(luong);
    ...
    public void addLuongLockFromVanTieu(final int luong) {
        if (luong <= 0) {
            return;
        }
        this.addLuongLockInternal(luong);
    ...
    public void addLuongLockFromLuongSonEvent(final int luong) {
        if (luong <= 0) {
            return;
        }
        this.addLuongLockInternal(luong);
    ...
    public void addLuongFromAdmin(final int luong) {
        if (luong <= 0) {
            return;
        }
        this.addLuongInternal(luong);
    ...
    public void addLuongLockFromAdmin(final int luong) {
        if (luong <= 0) {
            return;
        }
        this.addLuongLockInternal(luong);
    ...
    public void addLuong(final int luong) {
        this.logBlockedMoneyReward("luong", luong, "non_lucky_bag");
    }

    public void addLuongLock(final int luong) {
        this.logBlockedMoneyReward("luong_khoa", luong, "non_lucky_bag");
    }
...
//            System.out.println("Đã + 1 lượng vào điểm top event" + this.luongxai);
    ...
    public void resetBankTransferInput() {
        this.bankTransferType = -1;
        this.bankTransferTargetName = null;
    }

    public void clearBankPendingTransfer() {
        this.bankPendingTransferSender = null;
        this.bankPendingTransferType = -1;
        this.bankPendingTransferAmount = 0L;
        this.bankPendingTransferTime = 0L;
    ...
    public static synchronized void addLuongNapToTop(final Char p) {
        try {
            if (p.luongNap >= 10000L) {
                ...
                Logger.logStringWithDate(String.valueOf(p.charname) + "_" + p.luongNap + "_" + p.luong, "logs/runtime/logtopluong.txt");
            }
        } catch (final Exception ex) {
        }
    }
...
//        System.out.println("idEffDanhHieu: " + idEffDanhHieu +", currentDanhHieu: " + currentDanhHieu.getName());
    ...
    public String getInfoServer() {
        return "Nông dân: " + this.diemNongDan + " điểm.";
    }
