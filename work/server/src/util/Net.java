...
public class Net {
   private static boolean isLocalHttpUrl(URL url) {
   ...
   public static String getHttp(String urlstr) {
      ...
      try {
         ...
         if (!isLocalHttpUrl(url)) {
            System.out.println("Blocked non-local HTTP request: " + url.getHost());
            return "";
         }
   ...
   public static String getHttpLogin(String urlstr) {
      ...
      try {
         URL url = new URL(urlstr);
         if (!isLocalHttpUrl(url)) {
            System.out.println("Blocked non-local login HTTP request: " + url.getHost());
            return "";
         }
