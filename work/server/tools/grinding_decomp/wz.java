...
implements gj {
    ...
    public final void a() {
        ...
        if (this.b != -1) {
            ...
            ql2 = (ql)acv.s.z.elementAt(this.a.c);
        }
        ql ql3 = ql2;
        if (acv.s.t.u() >= 42 * acv.s.t.e) {
            im.a(this.a, "H\u00e0nh trang \u0111\u00e3 \u0111\u1ea7y", this.a.c % this.a.d * 18, this.a.c / this.a.d * 18);
            return;
        }
        yc yc3 = yi.b((int)ql2.r);
        if ((long)yc3.j > acv.s.t.bs) {
            im.a(this.a, "H\u1ebft ti\u1ec1n", this.a.c % this.a.d * 18, this.a.c / this.a.d * 18);
            return;
        }
        object = null;
        object = yc3.i == 0 ? "B\u1ea1n c\u00f3 mu\u1ed1n mua " + yc3.a + ", Gi\u00e1: " + yc3.j + "$ kh\u00f4ng?" : "B\u1ea1n c\u00f3 mu\u1ed1n thu\u00ea " + yc3.a + ", Gi\u00e1: " + yc3.j + "L\u01b0\u1ee3ng kh\u00f4ng?";
        acv.b((String)object, new xa(this, yc3, ql3));
    }
}
