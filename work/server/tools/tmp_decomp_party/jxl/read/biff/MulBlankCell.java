...
CellFeaturesAccessor {
    private static Logger logger = Logger.getLogger(class$jxl$read$biff$MulBlankCell == null ? (class$jxl$read$biff$MulBlankCell = MulBlankCell.class$("jxl.read.biff.MulBlankCell")) : class$jxl$read$biff$MulBlankCell);
    private int row;
    private int column;
